...
使用 Qwen3-VL 对商品标题、属性和三张商品图片进行一致性判断。当前数据、路径和统计以服务器实际文件为准。
...
| Joint train | 1,000 | 1,000 | 300/400/300 |
| Joint valid | 100 | 100 | 30/40/30 |
| Test | 200 | 200 | 100/60/40 |

规范目录为 `data/sft`、`data/joint`、`data/test`，每个目录的 JSONL 与 `images/` 配套保存。
